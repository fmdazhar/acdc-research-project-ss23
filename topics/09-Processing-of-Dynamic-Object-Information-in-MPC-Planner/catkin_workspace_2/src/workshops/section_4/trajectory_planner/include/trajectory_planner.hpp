...
#define EIGEN_STACK_ALLOCATION_LIMIT 131072 * 2* 10// 256KB
...
// class DistanceAvoidanceConstraint : public ct::optcon::ConstraintBase<STATE_DIM, CONTROL_DIM, SCALAR_EVAL, SCALAR>
// {
// public:
//     EIGEN_MAKE_ALIGNED_OPERATOR_NEW
//     typedef ct::optcon::ConstraintBase<STATE_DIM, CONTROL_DIM, SCALAR_EVAL, SCALAR> Base;
//     typedef ct::core::StateVector<STATE_DIM> state_vector_t;
//     typedef ct::core::ControlVector<CONTROL_DIM> control_vector_t;

//     DistanceAvoidanceConstraint(const std::vector<SCALAR_EVAL>& x_pred, const std::vector<SCALAR_EVAL>& y_pred)
//         : x_pred_(x_pred), y_pred_(y_pred)
//     {
//         Base::lb_.resize(1);
//         Base::ub_.resize(1);
//         Base::lb_.setConstant(0);
//         Base::ub_.setConstant(std::numeric_limits<SCALAR_EVAL>::max());
//     }

//     virtual DistanceAvoidanceConstraint *clone() const override
//     {
//         return new DistanceAvoidanceConstraint(*this);
//     }
...
//     virtual Eigen::VectorXd evaluate(const state_vector_t &x, const control_vector_t &u, const SCALAR &t) override;

// private:
//     std::vector<SCALAR_EVAL> x_pred_, y_pred_;
// };
...
public:
    ...
    tf2_ros::Buffer *transform_buffer = nullptr;
    ...
    void init()
    {
        ...
        // Sub
        combined_topic_sub_ = n.subscribe("combined_topic", 1000, &PLANNER::combinedTopicCallback, this);
        ...
        transform_buffer = new tf2_ros::Buffer;
        tf2_ros::TransformListener tfListener_(*transform_buffer);
    ...
    {
        // if (msg.child_frame_id == "vehicle_body")
    {
   ...
   //the found angles are written in a geometry_msgs::Vector3
    ...
    void publishTrajectory()
    {
        ...
        // std::cout << "time" << t_value[4] << std::endl;
...
protected:
    ...
    ros::Subscriber combined_topic_sub_;
    size_t K;
    std::vector<double> y_pred, x_pred; 
    ...
    // std::shared_ptr<ct::optcon::ConstraintContainerAD<state_dim, control_dim>> constraints;
    // ...
    ...
    bool isDistanceConstraintAdded = false;
